...
import { DraftPick } from '@/utils/types'
...
export async function finishGame(data: FinishGameData) {
    ...
    // We revalidate the specific match page too
    // We need to know the matchId to revalidate precise path, but revalidating the layout root or list is okay.
    // Ideally we return success and client redirects.
