        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="bg-slate-900 border-indigo-500/30 text-slate-100 w-[95vw] max-w-lg max-h-[90vh] overflow-y-auto p-4 md:p-6 rounded-xl">
                <DialogHeader className="border-b border-indigo-500/30 pb-4 mb-2">
                    <DialogTitle className="flex items-center gap-3 text-lg md:text-xl font-bold tracking-tight">
                    ...
                    <div className="space-y-3 md:space-y-4">
                        ...
                        {currentCounters.length > 0 && (
                            <div className="space-y-1.5 md:space-y-2">
                                <div className="flex items-center gap-2 text-rose-400 font-bold text-xs md:text-sm uppercase">
                        ...
                        {futureThreats.length > 0 && (
                            <div className="space-y-1.5 md:space-y-2">
                                <div className="flex items-center gap-2 text-amber-400 font-bold text-xs md:text-sm uppercase">
                        ...
                        {teamBenefits.length > 0 && (
                            <div className="space-y-1.5 md:space-y-2">
                                <div className="flex items-center gap-2 text-emerald-400 font-bold text-xs md:text-sm uppercase">
                        ...
                        {context && (
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3 pt-2 border-t border-white/5">
                        ...
                        {protectedAllies.length > 0 && (
                            <div className="space-y-1.5 md:space-y-2">
                                <div className="flex items-center gap-2 text-blue-400 font-bold text-xs md:text-sm uppercase">
                                    <LockOpen className="w-3.5 h-3.5 md:w-4 md:h-4" />
                        ...
                        {analysis.matchupData && (
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 pt-2 border-t border-white/5">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2 text-green-400 font-bold text-xs md:text-sm uppercase">
                                        <Swords className="w-3.5 h-3.5 md:w-4 md:h-4" />
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {analysis.matchupData.strongAgainst.slice(0, 8).map((hero, i) => (
                                                    <div key={i} className="group relative flex flex-col items-center">
                                                        <div className="relative w-9 h-9 md:w-10 md:h-10 rounded-full border border-green-500/50 overflow-hidden shadow-sm shadow-green-900/50 bg-green-950">
                                                            {hero.icon_url ? (
                                                                <Image
                                                                    src={hero.icon_url}
                                                                    alt={hero.name}
                                                        ...
                                                        <span className="text-[8px] md:text-[9px] text-green-200 mt-1 max-w-[48px] truncate text-center leading-tight">
                                                            {hero.name}
                                                        </span>
                                                    </div>
                                                ))}
                                ...
                                {/* Weak Against */}
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2 text-red-400 font-bold text-xs md:text-sm uppercase">
                                        <ShieldAlert className="w-3.5 h-3.5 md:w-4 md:h-4" />
                                        ...
                                        {analysis.matchupData.weakAgainst.length > 0 ? (
                                            <div className="flex flex-wrap gap-2">
                                                {analysis.matchupData.weakAgainst.slice(0, 8).map((hero, i) => (
                                                    <div key={i} className="group relative flex flex-col items-center">
                                                        <div className="relative w-9 h-9 md:w-10 md:h-10 rounded-full border border-red-500/50 overflow-hidden shadow-sm shadow-red-900/50 bg-red-950">
                                                            {hero.icon_url ? (
                                                                <Image
                                                                    src={hero.icon_url}
                                                                    alt={hero.name}
                                                        ...
                                                        <span className="text-[8px] md:text-[9px] text-red-200 mt-1 max-w-[48px] truncate text-center leading-tight">
                                                            {hero.name}
                                                        </span>
                                                    </div>
                                                ))}
