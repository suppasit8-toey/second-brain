...
interface CreateWinConditionDialogProps {
    open: boolean;
...
export function CreateWinConditionDialog({ open, onOpenChange, heroes, versions, tournaments = [], onSave }: CreateWinConditionDialogProps) {
            ...
            <DialogContent className="max-w-4xl bg-[#0B0E14] border-slate-800 text-slate-200 h-[85vh] flex flex-col p-0 gap-0 overflow-hidden shadow-[0_0_50px_-12px_rgba(124,58,237,0.2)]">
                ...
                <DialogHeader className="p-8 pb-4 relative z-10">
                    ...
                    <DialogDescription className="text-slate-400 text-base">
                        Define the team composition rules to analyze.
                    </DialogDescription>
                </DialogHeader>
